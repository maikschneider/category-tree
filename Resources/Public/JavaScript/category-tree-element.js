...
`,y=class extends U(D){constructor(){super(...arguments);this.tree=null;this.moduleStateType=C;this.configuration=null;this.refresh=()=>{this.resolveTree()?.refreshOrFilterTree()};this.selectFirstNode=()=>{this.resolveTree()?.selectFirstNode()};this.loadContent=e=>{let t=e.detail.node;if(!t?.checked||(P.updateWithTreeIdentifier(C,t.identifier,t.__treeIdentifier),e.detail.propagate===!1))return;let o=top.TYPO3.ModuleMenu.App,r=new URL(O.getFromName(o.getCurrentModule()).link,window.location.origin),a=new URL(top.TYPO3.Backend.ContentContainer.getUrl(),window.location.origin);a.pathname===r.pathname&&a.searchParams.forEach((n,s)=>{s!=="category"&&!r.searchParams.has(s)&&r.searchParams.set(s,n)}),t.identifier==="0"?r.searchParams.delete("category"):r.searchParams.set("category",t.identifier),top.TYPO3.Backend.ContentContainer.setUrl(r.toString())};this.showContextMenu=e=>{let t=e.detail.node,o=this.resolveTree();!t||t.identifier==="0"||!o||M.show(t.recordType,t.identifier,"tree","","",o.getElementFromNode(t),e.detail.originalEvent)}}connectedCallback(){super.connectedCallback(),document.addEventListener("typo3:categorytree:refresh",this.refresh),document.addEventListener("typo3:categorytree:selectFirstNode",this.selectFirstNode)}disconnectedCallback(){document.removeEventListener("typo3:categorytree:refresh",this.refresh),document.removeEventListener("typo3:categorytree:selectFirstNode",this.selectFirstNode),super.disconnectedCallback()}createRenderRoot(){return this}render(){return T`
    ...
    `}getConfiguration(){return this.configuration!==null?Promise.resolve(this.configuration):new b(top.TYPO3.settings.ajaxUrls.category_tree_configuration).get().then(async e=>(this.configuration=await e.resolve("json"),this.configuration))}resolveTree(){if(!this.tree){this.tree=this.querySelector("#typo3-categorytree-tree");let e=this.querySelector("#typo3-categorytree-toolbar");this.tree&&e&&(e.tree=this.tree)}return this.tree}};y=f([E("typo3-backend-navigation-component-category-tree")],y);var h=class extends R{firstUpdated(){this.resolveTree(),super.firstUpdated()}render(){return T`
