var _=Object.defineProperty;var x=Object.getOwnPropertyDescriptor;var f=(p,i,e,t)=>{for(var o=t>1?void 0:t?x(i,e):i,r=p.length-1,a;r>=0;r--)(a=p[r])&&(o=(t?a(i,e,o):a(o))||o);return t&&o&&_(i,e,o),o};import{html as T,LitElement as k}from"lit";import{customElement as C}from"lit/decorators.js";import{until as O}from"lit/directives/until.js";import{lll as m}from"@typo3/core/lit-helper.js";import w from"@typo3/core/ajax/ajax-request.js";import{ModuleUtility as D}from"@typo3/backend/module.js";import M from"@typo3/backend/context-menu.js";import E from"@typo3/backend/modal.js";import I from"@typo3/backend/severity.js";import{Tree as S}from"@typo3/backend/tree/tree.js";import{TreeNodeCommandEnum as s,TreeNodePositionEnum as l}from"@typo3/backend/tree/tree-node.js";import{TreeToolbar as R}from"@typo3/backend/tree/tree-toolbar.js";import{TreeModuleState as F}from"@typo3/backend/tree/tree-module-state.js";import{ModuleStateStorage as P}from"@typo3/backend/storage/module-state-storage.js";import{DataTransferTypes as b}from"@typo3/backend/enum/data-transfer-types.js";var Z="typo3-backend-navigation-component-category-tree",N="category",g="sys_category",u=class extends S{constructor(){super(...arguments);this.allowNodeEdit=!0;this.allowNodeDrag=!0;this.allowNodeSorting=!0}sendChangeCommand(e){let t="",o="0",r="0",a="0";if(e.target){let n=e.target;o=n.identifier;let d=n.parentIdentifier||"0";e.position===l.BEFORE?(o="-"+this.getPreviousNode(n).identifier,r=d,a=String(n.storagePid??0)):e.position===l.AFTER?(o="-"+o,r=d,a="-"+n.identifier):(o=String(n.storagePid??0),r=n.identifier,a=String(n.storagePid??0))}if(e.command===s.NEW){let n=e,d="data["+g+"]["+e.node.identifier+"]";t="&"+d+"[pid]="+encodeURIComponent(a)+"&"+d+"[parent]="+encodeURIComponent(r)+"&"+d+"[title]="+encodeURIComponent(n.title);let c=this.settings?.typeField,v=n.categoryType;c&&v!==void 0&&v!==""&&(t+="&"+d+"["+c+"]="+encodeURIComponent(String(v)))}else if(e.command===s.EDIT)t="&data["+g+"]["+e.node.identifier+"][title]="+encodeURIComponent(e.title);else if(e.command===s.DELETE)e.node.identifier===P.current(N).identifier&&this.selectFirstNode(),t="&cmd["+g+"]["+e.node.identifier+"][delete]=1";else{let n="cmd["+g+"]["+e.node.identifier+"]["+e.command+"]";t=n+"[action]=paste&"+n+"[target]="+encodeURIComponent(o)+"&"+n+"[update][parent]="+encodeURIComponent(r)}this.requestTreeUpdate(t).then(n=>{if(n&&n.hasErrors){this.errorNotification(n.messages);return}if(e.command===s.NEW){let d=this.getParentNode(e.node);d.loaded=!1,this.loadChildren(d)}else this.refreshOrFilterTree()})}async handleNodeEdit(e,t){if(e.__loading=!0,e.identifier.startsWith("NEW")){let o=this.getPreviousNode(e),r=e.depth===o.depth?l.AFTER:l.INSIDE;this.sendChangeCommand({command:s.NEW,node:e,title:t,position:r,target:o,categoryType:e.categoryType??""})}else this.sendChangeCommand({command:s.EDIT,node:e,title:t});e.__loading=!1}createDataTransferItemsFromNode(e){return[{type:b.treenode,data:this.getNodeTreeIdentifier(e)}]}async handleNodeAdd(e,t,o){this.updateComplete.then(()=>{this.editNode(e)})}handleNodeDelete(e){let t={node:e,command:s.DELETE};if(!this.settings.displayDeleteConfirmation){this.sendChangeCommand(t);return}let o=E.confirm(TYPO3.lang["mess.delete.title"],TYPO3.lang["mess.delete"].replace("%s",t.node.name),I.warning,[{text:TYPO3.lang["labels.cancel"]||"Cancel",active:!0,btnClass:"btn-default",name:"cancel"},{text:TYPO3.lang.delete||"Delete",btnClass:"btn-warning",name:"delete"}]);o.addEventListener("button.clicked",r=>{r.target.name==="delete"&&this.sendChangeCommand(t),o.hideModal()})}handleNodeMove(e,t,o){let r={node:e,target:t,position:o,command:s.MOVE},a;switch(o){case l.BEFORE:a=TYPO3.lang["mess.move_before"];break;case l.AFTER:a=TYPO3.lang["mess.move_after"];break;default:a=TYPO3.lang["mess.move_into"];break}a=a.replace("%s",e.name).replace("%s",t.name);let n=E.confirm(TYPO3.lang.move_page,a,I.warning,[{text:TYPO3.lang["labels.cancel"]||"Cancel",active:!0,btnClass:"btn-default",name:"cancel"},{text:TYPO3.lang["cm.copy"]||"Copy",btnClass:"btn-warning",name:"copy"},{text:TYPO3.lang["labels.move"]||"Move",btnClass:"btn-warning",name:"move"}]);n.addEventListener("button.clicked",d=>{let c=d.target.name;(c==="move"||c==="copy")&&(r.command=c==="move"?s.MOVE:s.COPY,this.sendChangeCommand(r)),n.hideModal()})}requestTreeUpdate(e){return new w(top.TYPO3.settings.ajaxUrls.record_process).post(e,{headers:{"Content-Type":"application/x-www-form-urlencoded","X-Requested-With":"XMLHttpRequest"}}).then(t=>t.resolve()).catch(t=>{this.errorNotification(t),this.loadData()})}};u=f([C("typo3-backend-navigation-component-category-tree-tree")],u);var L=`
...
`,y=class extends F(k){constructor(){super(...arguments);this.tree=null;this.moduleStateType=N;this.configuration=null;this.refresh=()=>{this.resolveTree()?.refreshOrFilterTree()};this.selectFirstNode=()=>{this.resolveTree()?.selectFirstNode()};this.loadContent=e=>{let t=e.detail.node;if(!t?.checked||(P.updateWithTreeIdentifier(N,t.identifier,t.__treeIdentifier),e.detail.propagate===!1))return;let o=top.TYPO3.ModuleMenu.App,r=new URL(D.getFromName(o.getCurrentModule()).link,window.location.origin),a=new URL(top.TYPO3.Backend.ContentContainer.getUrl(),window.location.origin);a.pathname===r.pathname&&a.searchParams.forEach((n,d)=>{d!=="category"&&!r.searchParams.has(d)&&r.searchParams.set(d,n)}),t.identifier==="0"?r.searchParams.delete("category"):r.searchParams.set("category",t.identifier),top.TYPO3.Backend.ContentContainer.setUrl(r.toString())};this.showContextMenu=e=>{let t=e.detail.node,o=this.resolveTree();!t||t.identifier==="0"||!o||M.show(t.recordType,t.identifier,"tree","","",o.getElementFromNode(t),e.detail.originalEvent)}}connectedCallback(){super.connectedCallback(),document.addEventListener("typo3:categorytree:refresh",this.refresh),document.addEventListener("typo3:categorytree:selectFirstNode",this.selectFirstNode)}disconnectedCallback(){document.removeEventListener("typo3:categorytree:refresh",this.refresh),document.removeEventListener("typo3:categorytree:selectFirstNode",this.selectFirstNode),super.disconnectedCallback()}createRenderRoot(){return this}render(){return T`
      <style>${L}</style>
    ...
    `}getConfiguration(){return this.configuration!==null?Promise.resolve(this.configuration):new w(top.TYPO3.settings.ajaxUrls.category_tree_configuration).get().then(async e=>(this.configuration=await e.resolve("json"),this.configuration))}resolveTree(){if(!this.tree){this.tree=this.querySelector("#typo3-categorytree-tree");let e=this.querySelector("#typo3-categorytree-toolbar");this.tree&&e&&(e.tree=this.tree)}return this.tree}};y=f([C("typo3-backend-navigation-component-category-tree")],y);var h=class extends R{firstUpdated(){this.resolveTree(),super.firstUpdated()}render(){return T`
