var O=Object.defineProperty;var _=Object.getOwnPropertyDescriptor;var u=(m,i,e,t)=>{for(var o=t>1?void 0:t?_(i,e):i,r=m.length-1,a;r>=0;r--)(a=m[r])&&(o=(t?a(i,e,o):a(o))||o);return t&&o&&O(i,e,o),o};import{html as T,LitElement as M}from"lit";import{customElement as E}from"lit/decorators.js";import{until as x}from"lit/directives/until.js";import{lll as g}from"@typo3/core/lit-helper.js";import b from"@typo3/core/ajax/ajax-request.js";import{ModuleUtility as D}from"@typo3/backend/module.js";import k from"@typo3/backend/context-menu.js";import w from"@typo3/backend/modal.js";import I from"@typo3/backend/severity.js";import{Tree as L}from"@typo3/backend/tree/tree.js";import{TreeNodeCommandEnum as d,TreeNodePositionEnum as c}from"@typo3/backend/tree/tree-node.js";import{TreeToolbar as S}from"@typo3/backend/tree/tree-toolbar.js";import{TreeModuleState as R}from"@typo3/backend/tree/tree-module-state.js";import{ModuleStateStorage as P}from"@typo3/backend/storage/module-state-storage.js";import{DataTransferTypes as N}from"@typo3/backend/enum/data-transfer-types.js";var Z="typo3-backend-navigation-component-category-tree",C="category",p="sys_category",f=class extends L{constructor(){super(...arguments);this.allowNodeEdit=!0;this.allowNodeDrag=!0;this.allowNodeSorting=!0}sendChangeCommand(e){let t="",o="0",r="0",a="0";if(e.target){let n=e.target;o=n.identifier;let s=n.parentIdentifier||"0";e.position===c.BEFORE?(o="-"+this.getPreviousNode(n).identifier,r=s,a=String(n.storagePid??0)):e.position===c.AFTER?(o="-"+o,r=s,a="-"+n.identifier):(o=String(n.storagePid??0),r=n.identifier,a=String(n.storagePid??0))}if(e.command===d.NEW){let n=e,s="data["+p+"]["+e.node.identifier+"]";t="&"+s+"[pid]="+encodeURIComponent(a)+"&"+s+"[parent]="+encodeURIComponent(r)+"&"+s+"[title]="+encodeURIComponent(n.title);let l=this.settings?.typeField,v=n.categoryType;l&&v!==void 0&&v!==""&&(t+="&"+s+"["+l+"]="+encodeURIComponent(String(v)))}else if(e.command===d.EDIT)t="&data["+p+"]["+e.node.identifier+"][title]="+encodeURIComponent(e.title);else if(e.command===d.DELETE)e.node.identifier===P.current(C).identifier&&this.selectFirstNode(),t=[...e.descendants,e.node.identifier].map(n=>"&cmd["+p+"]["+n+"][delete]=1").join("");else{let n="cmd["+p+"]["+e.node.identifier+"]["+e.command+"]";t=n+"[action]=paste&"+n+"[target]="+encodeURIComponent(o)+"&"+n+"[update][parent]="+encodeURIComponent(r)}this.requestTreeUpdate(t).then(n=>{if(n&&n.hasErrors){this.errorNotification(n.messages);return}if(e.command===d.NEW){let s=this.getParentNode(e.node);s.loaded=!1,this.loadChildren(s)}else this.refreshOrFilterTree()})}async handleNodeEdit(e,t){if(e.__loading=!0,e.identifier.startsWith("NEW")){let o=this.getPreviousNode(e),r=e.depth===o.depth?c.AFTER:c.INSIDE;this.sendChangeCommand({command:d.NEW,node:e,title:t,position:r,target:o,categoryType:e.categoryType??""})}else this.sendChangeCommand({command:d.EDIT,node:e,title:t});e.__loading=!1}createDataTransferItemsFromNode(e){return[{type:N.treenode,data:this.getNodeTreeIdentifier(e)}]}async handleNodeAdd(e,t,o){this.updateComplete.then(()=>{this.editNode(e)})}handleNodeDelete(e){let t=()=>{this.fetchDescendants(e.identifier).then(r=>{this.sendChangeCommand({node:e,command:d.DELETE,descendants:r})}).catch(r=>this.errorNotification(r))};if(!this.settings.displayDeleteConfirmation){t();return}let o=w.confirm(TYPO3.lang["mess.delete.title"],TYPO3.lang["mess.delete"].replace("%s",e.name),I.warning,[{text:TYPO3.lang["labels.cancel"]||"Cancel",active:!0,btnClass:"btn-default",name:"cancel"},{text:TYPO3.lang.delete||"Delete",btnClass:"btn-warning",name:"delete"}]);o.addEventListener("button.clicked",r=>{r.target.name==="delete"&&t(),o.hideModal()})}async fetchDescendants(e){let t=this.settings?.descendantsUrl;return!t||e.startsWith("NEW")?[]:(await(await new b(t).withQueryArguments({identifier:e}).get()).resolve("json")).descendants??[]}handleNodeMove(e,t,o){let r={node:e,target:t,position:o,command:d.MOVE},a;switch(o){case c.BEFORE:a=TYPO3.lang["mess.move_before"];break;case c.AFTER:a=TYPO3.lang["mess.move_after"];break;default:a=TYPO3.lang["mess.move_into"];break}a=a.replace("%s",e.name).replace("%s",t.name);let n=w.confirm(TYPO3.lang.move_page,a,I.warning,[{text:TYPO3.lang["labels.cancel"]||"Cancel",active:!0,btnClass:"btn-default",name:"cancel"},{text:TYPO3.lang["cm.copy"]||"Copy",btnClass:"btn-warning",name:"copy"},{text:TYPO3.lang["labels.move"]||"Move",btnClass:"btn-warning",name:"move"}]);n.addEventListener("button.clicked",s=>{let l=s.target.name;(l==="move"||l==="copy")&&(r.command=l==="move"?d.MOVE:d.COPY,this.sendChangeCommand(r)),n.hideModal()})}requestTreeUpdate(e){return new b(top.TYPO3.settings.ajaxUrls.record_process).post(e,{headers:{"Content-Type":"application/x-www-form-urlencoded","X-Requested-With":"XMLHttpRequest"}}).then(t=>t.resolve()).catch(t=>{this.errorNotification(t),this.loadData()})}};f=u([E("typo3-backend-navigation-component-category-tree-tree")],f);var F=`
...
`,y=class extends R(M){constructor(){super(...arguments);this.tree=null;this.moduleStateType=C;this.configuration=null;this.treeTriggeredModuleLoad=!1;this.refresh=()=>{this.resolveTree()?.refreshOrFilterTree()};this.selectFirstNode=()=>{this.resolveTree()?.selectFirstNode()};this.refreshOnCategoryWrite=e=>{e.detail?.payload?.table===p&&this.resolveTree()?.refreshOrFilterTree()};this.refreshOnModuleLoad=()=>{if(this.treeTriggeredModuleLoad){this.treeTriggeredModuleLoad=!1;return}this.resolveTree()?.refreshOrFilterTree()};this.loadContent=e=>{let t=e.detail.node;if(!t?.checked||(P.updateWithTreeIdentifier(C,t.identifier,t.__treeIdentifier),e.detail.propagate===!1))return;let o=top.TYPO3.ModuleMenu.App,r=new URL(D.getFromName(o.getCurrentModule()).link,window.location.origin),a=new URL(top.TYPO3.Backend.ContentContainer.getUrl(),window.location.origin);a.pathname===r.pathname&&a.searchParams.forEach((n,s)=>{s!=="category"&&!r.searchParams.has(s)&&r.searchParams.set(s,n)}),t.identifier==="0"?r.searchParams.delete("category"):r.searchParams.set("category",t.identifier),this.treeTriggeredModuleLoad=!0,top.TYPO3.Backend.ContentContainer.setUrl(r.toString())};this.showContextMenu=e=>{let t=e.detail.node,o=this.resolveTree();!t||t.identifier==="0"||!o||k.show(t.recordType,t.identifier,"tree","","",o.getElementFromNode(t),e.detail.originalEvent)}}connectedCallback(){super.connectedCallback(),document.addEventListener("typo3:categorytree:refresh",this.refresh),document.addEventListener("typo3:categorytree:selectFirstNode",this.selectFirstNode),document.addEventListener("typo3:datahandler:process",this.refreshOnCategoryWrite),document.addEventListener("typo3-module-loaded",this.refreshOnModuleLoad)}disconnectedCallback(){document.removeEventListener("typo3:categorytree:refresh",this.refresh),document.removeEventListener("typo3:categorytree:selectFirstNode",this.selectFirstNode),document.removeEventListener("typo3:datahandler:process",this.refreshOnCategoryWrite),document.removeEventListener("typo3-module-loaded",this.refreshOnModuleLoad),super.disconnectedCallback()}createRenderRoot(){return this}render(){return T`
    ...
    `}getConfiguration(){return this.configuration!==null?Promise.resolve(this.configuration):new b(top.TYPO3.settings.ajaxUrls.category_tree_configuration).withQueryArguments({module:this.getCurrentModuleIdentifier()}).get().then(async e=>(this.configuration=await e.resolve("json"),this.configuration))}getCurrentModuleIdentifier(){return top.TYPO3.ModuleMenu?.App?.getCurrentModule()??""}resolveTree(){if(!this.tree){this.tree=this.querySelector("#typo3-categorytree-tree");let e=this.querySelector("#typo3-categorytree-toolbar");this.tree&&e&&(e.tree=this.tree)}return this.tree}};y=u([E("typo3-backend-navigation-component-category-tree")],y);var h=class extends S{firstUpdated(){this.resolveTree(),super.firstUpdated()}render(){return T`
